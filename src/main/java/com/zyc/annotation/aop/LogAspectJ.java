package com.zyc.annotation.aop;
...
public class LogAspectJ {
    ...
    /**
     * 抽取公共的切入点表达式
     * 1、本类引用：@Pointcut("public int com.zyc.annotation.aop.MathTest.*(..)")
     * 2、其他切面引用：@Pointcut("execution(public int com.zyc.annotation.aop.MathTest.*(..))")
     * 3、可以使用不带修饰符域返回值： @Pointcut("execution(* com.spring.one.chapterFour.aspectOrientedProgramming.Performance.perfrom(..))")
     */
    @Pointcut("execution(public int com.zyc.annotation.aop.MathTest.*(..))")
